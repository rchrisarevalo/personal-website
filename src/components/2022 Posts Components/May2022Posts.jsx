...
const May2022Posts = () => {
    ...
    return (
        <div class="posts-main">
            <Helmet>
                <title>
                    Ruben C. Arevalo - Personal Website - Announcements (May 2022)
                </title>
            </Helmet>
            <NavArchives />
            <div class="posts-container">
                ...
                <h1 id="posts-title">Announcements (May 2022)</h1>
                <br></br>
                <p id="posts-description">
                    These are all the posts for May 2022 that were archived on this
