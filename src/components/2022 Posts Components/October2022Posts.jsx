...
const October2022Posts = () => {
        ...
        axios.get("https://rchrisarevalo.github.io/posts.json", db.post).then((res) => {
            ...
            if (currentPostNum === prevPostNum) {
                for (var i = db.post.length - 1; i >= 0; i--) {
                    if (db.post[i].month === 10 && db.post[i].year === 2022) {
    ...
    return (
        <div class="posts-main">
            <Helmet>
                <title>
                    Ruben C. Arevalo - Personal Website - Announcements (October 2022)
                </title>
            </Helmet>
            <NavArchives />
            <div class="posts-container">
                ...
                {Date.now() >= new Date(2022, 11, 1, 0, 0, 0) &&
                    <Link to="/announcements/2022/November">
                ...
                <h1 id="posts-title">Announcements (October 2022)</h1>
                <br></br>
                <p id="posts-description">
                    These are all the posts for October 2022 that were archived on this
...
export default October2022Posts;