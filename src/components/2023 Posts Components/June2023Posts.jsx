...
const June2023Posts = () => {
        ...
        axios.get("https://rchrisarevalo.github.io/posts.json", db.post).then((res) => {
            ...
            if (currentPostNum === prevPostNum) {
                for (var i = db.post.length - 1; i >= 0; i--) {
                    if (db.post[i].month === 6 && db.post[i].year === 2023) {
    ...
    return (
        <div class="posts-main">
            <Helmet>
                <title>
                    Ruben C. Arevalo - Personal Website - Announcements (June 2023)
                </title>
            </Helmet>
            <NavArchives />
            <div class="posts-container">
                ...
                {Date.now() >= new Date(2023, 7, 1, 0, 0, 0) &&
                ...
                <h1 id="posts-title">Announcements (June 2023)</h1>
                <br></br>
                <p id="posts-description">
                    These are all the posts for June 2023 that were archived on this
