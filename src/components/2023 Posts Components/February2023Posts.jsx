...
const February2023Posts = () => {
        ...
        axios.get("https://rchrisarevalo.github.io/posts.json", db.post).then((res) => {
            ...
            if (currentPostNum === prevPostNum) {
                for (var i = db.post.length - 1; i >= 0; i--) {
                    if (db.post[i].month === 2 && db.post[i].year === 2023) {
    ...
    return (
        <div class="posts-main">
            <Helmet>
                <title>
                    Ruben C. Arevalo - Personal Website - Announcements (February 2023)
                </title>
            </Helmet>
            <NavArchives />
            <div class="posts-container">
                <Link to="/announcements/2023/January">
                ...
                <h1 id="posts-title">Announcements (February 2023)</h1>
                <br></br>
                <p id="posts-description">
                    These are all the posts for February 2023 that were archived on this
...
export default February2023Posts;