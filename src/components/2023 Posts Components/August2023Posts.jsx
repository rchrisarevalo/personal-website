...
const August2023Posts = () => {
        ...
        axios.get("https://rchrisarevalo.github.io/posts.json", db.post).then((res) => {
            ...
            if (currentPostNum === prevPostNum) {
                for (var i = db.post.length - 1; i >= 0; i--) {
                    if (db.post[i].month === 8 && db.post[i].year === 2023) {
    ...
    return (
        <div class="posts-main">
            <Helmet>
                <title>
                    Ruben C. Arevalo - Personal Website - Announcements (August 2023)
                </title>
            </Helmet>
            <NavArchives />
            <div class="posts-container">
                <Link to="/announcements/2023/July">
                ...
                {Date.now() >= new Date(2023, 9, 1, 0, 0, 0) &&
                    <Link to="/announcements/2023/September">
                ...
                <h1 id="posts-title">Announcements (August 2023)</h1>
                <br></br>
                <p id="posts-description">
                    These are all the posts for August 2023 that were archived on this
...
export default August2023Posts;