    ...
    return (
        ...
        <div className="error-container">
            <div className="error-message">
                ...
                <p>As part of a new website operating policy, I have deciced to close this website</p>
                <p>for today due to the holidays. If you have any questions, please feel free to</p>
                <p>contact me by clicking the "Contact Me" button below the description.</p>
                <br />
